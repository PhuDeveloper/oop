...
import static com.tpd.utils.convertEng.removeAccent;
...
public class FormDetailInvoice extends javax.swing.JFrame {
    ...
    public void outputPDF() throws IOException, BadElementException {
        ...
        String file = "src\\com\\raven\\icon\\shop_logo.png";
        ...
        table.addCell(new Cell().add(image).setBorder(Border.NO_BORDER)).setMarginLeft(30f);
        table.addCell(new Cell().add("").setBorder(Border.NO_BORDER)).setMarginLeft(30f);
        table.addCell(new Cell().add("CLICK-CLICK SHOP").setFontSize(16f).setBorder(Border.NO_BORDER).setBold());
        table.addCell(new Cell().add("97 Man Thien,Hiep Phu, Thu Duc, HCM \n SĐT: 0908946550 - 0123456789")
                .setTextAlignment(TextAlignment.CENTER).setMarginTop(30f).setMarginBottom(30f).setBorder(Border.NO_BORDER).setMarginRight(10f)
        );
        ...
        customerInfor.addCell(new Cell(0, 4).add("HOA DON NHAP HANG").setFontSize(22f).setBold().setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.CENTER));
    ...
    private void myButton7ActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            // TODO add your handling code here:
            outputPDF();
