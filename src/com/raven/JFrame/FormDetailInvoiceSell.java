...
public class FormDetailInvoiceSell extends javax.swing.JFrame {
    ...
    public FormDetailInvoiceSell(int id, DefaultTableModel model, int row) {
        ...
        fillTable(id);
        java.awt.Image icon = Toolkit.getDefaultToolkit().getImage("src\\com\\raven\\icon\\shop(3).png");
    ...
    private void initComponents() {
        ...
        myButton7.setBackground(new java.awt.Color(255, 153, 51));
    ...
    private void myButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                          
    ...
    public void outputPDF() throws IOException, BadElementException {
        ...
        table.addCell(new Cell().add("97 Man Thien,Hiep Phu, Thu Duc, HCM \n SĐT: 0908946550 - 0123456789")
                .setTextAlignment(TextAlignment.RIGHT).setMarginTop(15f).setMarginBottom(30f).setBorder(Border.NO_BORDER).setMarginRight(10f)
        );
