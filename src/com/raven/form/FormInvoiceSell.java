...
public class FormInvoiceSell extends javax.swing.JPanel {
    ...
    public void fillPagination() {
        ...
        for (InvoiceSell i : listSell) {
            ...
            model.addRow(new Object[]{
                    i.getIdInvoiceSell(), i.getNameCustomer(), phone, i.getNameUser(), nf.format(i.getPrice()) + " đ", i.getDateCreateInvoice(), i.getDescription(), "Đã thanh toán"});
            else
                model.addRow(new Object[]{
                    i.getIdInvoiceSell(), i.getNameCustomer(), phone, i.getNameUser(), nf.format(i.getPrice()) + " đ", i.getDateCreateInvoice(), i.getDescription(), "Chưa thanh toán"});
        }
    }
    ...
    public void fillSearch() {
        ...
        if (i == null) {
            lblSearchId.setVisible(true);
            lblSearchId.setText("Không có mặt hàng nào có mã bằng " + id);
            return;
        }
    ...
    private void initComponents() {
        ...
        myButton6.setText("Xuất file Excel");
